 ...
 * 
 */
@Entity(name = "cond_certificates_lines")
public class CondCertificateLine extends CertificateLine {

	
	private static final long serialVersionUID = -6482140941430621217L;
	...
	public double getUncertianity() {
		uncertianity = calculateUncertianity();
		return uncertianity;
	}
	...
	private double calculateUncertianity(){
		// TODO add formual
		return 0;
	}
