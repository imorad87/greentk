 ...
 * 
 */
@Entity(name = "td_certificates_lines")
public class TDCertificateLine extends CertificateLine {

	
	private static final long serialVersionUID = -427397135138820696L;
	...
	public double calculateCorrection() {
		Double d = new Double(getReferenceReading() - getUnitUnderTestReading());
