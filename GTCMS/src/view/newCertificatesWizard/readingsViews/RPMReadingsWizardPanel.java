...
import tableModels.readingsTableModels.RPMReadingTableModel;
...
public class RPMReadingsWizardPanel extends WizardPanel implements ReadingsPanel {
	...
	private RPMReadingTableModel rReadingTableModel;
	...
	public RPMReadingsWizardPanel() {
		...
		rReadingTableModel = new RPMReadingTableModel();
		setPreferredSize(new Dimension(646, 335));
		setLayout(null);

		JLabel lblTemperature = new JLabel("RPM Calibration Result");
		...
		addButton.setIcon(new ImageIcon(RPMReadingsWizardPanel.class
		...
		removeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (row >= 0) {
					RPMReadingTableModel tableModel = (RPMReadingTableModel) table
							.getModel();
		...
		removeButton.setIcon(new ImageIcon(RPMReadingsWizardPanel.class
		...
		removeAllButton.setIcon(new ImageIcon(RPMReadingsWizardPanel.class
