...
public class THReadingsWizardPanel extends WizardPanel implements ReadingsPanel {
	...
	public THReadingsWizardPanel(){
		init();
	}
	/**
	 * Create the panel.
	 */
	public THReadingsWizardPanel(double maxRange, double acceptanceLimit, int type) {
	...
	private void init(){
		...
		addButton.setIcon(new ImageIcon(THReadingsWizardPanel.class
		...
		removeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (row >= 0) {
					...
					JOptionPane
							.showMessageDialog(THReadingsWizardPanel.this,
		...
		removeButton.setIcon(new ImageIcon(THReadingsWizardPanel.class
		...
		removeAllButton.setIcon(new ImageIcon(THReadingsWizardPanel.class
