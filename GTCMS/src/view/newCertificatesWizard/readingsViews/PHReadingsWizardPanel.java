...
public class PHReadingsWizardPanel extends WizardPanel implements ReadingsPanel {
	...
	public PHReadingsWizardPanel(){
		init();
	}
	/**
	 * Create the panel.
	 */
	public PHReadingsWizardPanel(double maxRange, double acceptanceLimit, int type) {
	...
	private void init(){
		...
		addButton.setIcon(new ImageIcon(PHReadingsWizardPanel.class
		...
		removeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (row >= 0) {
					...
					JOptionPane
							.showMessageDialog(PHReadingsWizardPanel.this,
		...
		removeButton.setIcon(new ImageIcon(PHReadingsWizardPanel.class
		...
		removeAllButton.setIcon(new ImageIcon(PHReadingsWizardPanel.class
