...
public class RHReadingsWizardPanel extends WizardPanel implements ReadingsPanel {
	...
	public RHReadingsWizardPanel(){
		init();
	}
	/**
	 * Create the panel.
	 */
	public RHReadingsWizardPanel(double maxRange, double acceptanceLimit, int type) {
	...
	private void init(){
		...
		addButton.setIcon(new ImageIcon(RHReadingsWizardPanel.class
		...
		removeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (row >= 0) {
					...
					JOptionPane
							.showMessageDialog(RHReadingsWizardPanel.this,
		...
		removeButton.setIcon(new ImageIcon(RHReadingsWizardPanel.class
		...
		removeAllButton.setIcon(new ImageIcon(RHReadingsWizardPanel.class
